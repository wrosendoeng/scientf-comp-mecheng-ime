module create
    ...
    subroutine matrices_ab(a,b)

    integer(4) :: i,j, unit1, unit2
    real(8), parameter :: pi = 3.14159265358979323846264338327950288419716939937510
    real(8) :: alpha
    real(8), dimension(17) :: v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17
    real(8), dimension(17,17), intent(out) :: a
    real(8), dimension(17), intent(out) :: b
