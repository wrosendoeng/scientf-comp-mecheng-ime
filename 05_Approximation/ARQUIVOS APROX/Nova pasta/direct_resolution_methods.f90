MODULE direct_resolution_methods
    ...
    subroutine elimination(a,b,x,n)
        ...
        integer(fgsl_int) :: i, j, k, l_pivot, n
        real(fgsl_double) :: m, pivot,soma, troca, a(n,n), b(n), x(n)
    ...
    subroutine lufactorization(a,b,x,n)
        ...
        integer(fgsl_int) :: aux, i, j, k, l_pivot, n, p(n)
        real(fgsl_double) :: m, pivot, troca, a(n,n), b(n), c(n), y(n)
